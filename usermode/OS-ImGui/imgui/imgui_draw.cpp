...
void ImGui::C2CDefaultStyle(ImGuiStyle* dst)
{
    ...
    style.Colors[ImGuiCol_FrameBgActive]         = ImVec4(0.22f, 0.22f, 0.25f, 1.00f);
    ...
    style.Colors[ImGuiCol_MenuBarBg]             = ImVec4(0.10f, 0.10f, 0.11f, 1.00f);
    style.Colors[ImGuiCol_ScrollbarBg]           = ImVec4(0.09f, 0.09f, 0.10f, 1.00f);
    style.Colors[ImGuiCol_ScrollbarGrab]         = ImVec4(0.86f, 0.28f, 0.22f, 0.80f);
    style.Colors[ImGuiCol_ScrollbarGrabHovered]  = ImVec4(0.92f, 0.38f, 0.28f, 1.00f);
    style.Colors[ImGuiCol_ScrollbarGrabActive]   = ImVec4(1.00f, 0.45f, 0.30f, 1.00f);
    style.Colors[ImGuiCol_CheckMark]             = ImVec4(0.90f, 0.32f, 0.22f, 1.00f);
    style.Colors[ImGuiCol_SliderGrab]            = ImVec4(0.86f, 0.28f, 0.22f, 1.00f);
    style.Colors[ImGuiCol_SliderGrabActive]      = ImVec4(1.00f, 0.45f, 0.30f, 1.00f);
    style.Colors[ImGuiCol_Button]                = ImVec4(0.16f, 0.16f, 0.18f, 1.00f);
    style.Colors[ImGuiCol_ButtonHovered]         = ImVec4(0.86f, 0.28f, 0.22f, 0.85f);
    style.Colors[ImGuiCol_ButtonActive]          = ImVec4(1.00f, 0.40f, 0.28f, 1.00f);
    style.Colors[ImGuiCol_Header]                = ImVec4(0.16f, 0.16f, 0.18f, 1.00f);
    style.Colors[ImGuiCol_HeaderHovered]         = ImVec4(0.20f, 0.20f, 0.23f, 1.00f);
    style.Colors[ImGuiCol_HeaderActive]          = ImVec4(0.86f, 0.28f, 0.22f, 0.40f);
    style.Colors[ImGuiCol_Separator]             = ImVec4(0.20f, 0.20f, 0.22f, 1.00f);
    style.Colors[ImGuiCol_SeparatorHovered]      = ImVec4(0.86f, 0.28f, 0.22f, 0.60f);
    style.Colors[ImGuiCol_SeparatorActive]       = ImVec4(0.86f, 0.28f, 0.22f, 1.00f);
    style.Colors[ImGuiCol_ResizeGrip]            = ImVec4(0.20f, 0.20f, 0.22f, 1.00f);
    style.Colors[ImGuiCol_ResizeGripHovered]     = ImVec4(0.86f, 0.28f, 0.22f, 0.80f);
    style.Colors[ImGuiCol_ResizeGripActive]      = ImVec4(1.00f, 0.45f, 0.30f, 1.00f);
    style.Colors[ImGuiCol_Tab]                   = ImVec4(0.09f, 0.09f, 0.10f, 1.00f);
    style.Colors[ImGuiCol_TabHovered]            = ImVec4(0.86f, 0.28f, 0.22f, 0.80f);
    style.Colors[ImGuiCol_TabActive]             = ImVec4(0.86f, 0.28f, 0.22f, 1.00f);
    style.Colors[ImGuiCol_TabUnfocused]          = ImVec4(0.09f, 0.09f, 0.10f, 1.00f);
    style.Colors[ImGuiCol_TabUnfocusedActive]    = ImVec4(0.16f, 0.16f, 0.18f, 1.00f);
    style.Colors[ImGuiCol_PlotLines]             = ImVec4(0.86f, 0.28f, 0.22f, 1.00f);
    style.Colors[ImGuiCol_PlotLinesHovered]      = ImVec4(1.00f, 0.45f, 0.30f, 1.00f);
    style.Colors[ImGuiCol_PlotHistogram]         = ImVec4(0.86f, 0.28f, 0.22f, 1.00f);
    style.Colors[ImGuiCol_PlotHistogramHovered]  = ImVec4(1.00f, 0.45f, 0.30f, 1.00f);
    style.Colors[ImGuiCol_TableHeaderBg]         = ImVec4(0.11f, 0.11f, 0.13f, 1.00f);
    style.Colors[ImGuiCol_TableBorderStrong]     = ImVec4(0.20f, 0.20f, 0.22f, 1.00f);
    style.Colors[ImGuiCol_TableBorderLight]      = ImVec4(0.16f, 0.16f, 0.18f, 1.00f);
    style.Colors[ImGuiCol_TableRowBg]            = ImVec4(0.00f, 0.00f, 0.00f, 0.00f);
    style.Colors[ImGuiCol_TableRowBgAlt]         = ImVec4(0.13f, 0.13f, 0.15f, 0.50f);
    style.Colors[ImGuiCol_TextSelectedBg]        = ImVec4(0.86f, 0.28f, 0.22f, 0.35f);
    style.Colors[ImGuiCol_DragDropTarget]        = ImVec4(0.86f, 0.28f, 0.22f, 0.90f);
    style.Colors[ImGuiCol_NavHighlight]          = ImVec4(0.86f, 0.28f, 0.22f, 1.00f);
    style.Colors[ImGuiCol_NavWindowingHighlight] = ImVec4(0.86f, 0.28f, 0.22f, 0.70f);
    style.Colors[ImGuiCol_NavWindowingDimBg]     = ImVec4(0.09f, 0.09f, 0.10f, 0.70f);
    style.Colors[ImGuiCol_ModalWindowDimBg]      = ImVec4(0.09f, 0.09f, 0.10f, 0.70f);
}
